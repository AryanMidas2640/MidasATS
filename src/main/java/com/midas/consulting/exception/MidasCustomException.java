...
import com.midas.consulting.config.PropertiesConfig;
 ...
 */
@Component
public class MidasCustomException extends Throwable{

    private static PropertiesConfig propertiesConfig;

    @Autowired
    public MidasCustomException(PropertiesConfig propertiesConfig) {
        MidasCustomException.propertiesConfig = propertiesConfig;
    }
